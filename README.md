...
### 1. 모니터 배치를 실제 책상과 맞춥니다

![메인 화면](docs/screen-main.webp)

모니터를 끌어서 옮기면 됩니다. 크기는 모니터에서 읽어 온 실물 치수라
27인치 옆의 24인치가 화면에서도 그만큼 작게 보입니다.

### 2. 모니터마다 폴더를 지정합니다

![바탕화면 설정](docs/screen-wallpaper.webp)

모니터 카드마다 폴더를 하나씩 지정합니다. 간격과 재생 방식도 따로 줄 수 있고,
전역 설정을 그대로 쓰게 둘 수도 있습니다.

### 3. 화면 보호기도 따로 정합니다

![화면 보호기 설정](docs/screen-screensaver.webp)

바탕화면과 같은 폴더를 써도 되고, 모니터마다 전용 폴더를 따로 줘도 됩니다.
저장하면 Windows 화면 보호기 목록에 등록됩니다.

### 4. 밝기와 빛 강조를 한 점으로 잡습니다

| 밝기 −25% · 빛 강조 90% | 밝기 +65% · 빛 강조 40% |
|---|---|
| ![어둡게 보정](docs/screen-look-dark.webp) | ![밝게 보정](docs/screen-look-bright.webp) |

왼쪽 아래 2D 패널에서 점 하나를 옮기면 밝기와 빛 강조가 함께 정해집니다.
저장을 눌러야 반영되므로 마음껏 만져 봐도 됩니다.
